...
public class WithholdingTest {
    ...
    private static String noticeUrl = "http://localhost:6986/r/deduction/notice";
    private static String pushUpTheStandardUrl = "http://localhost:6986/r/datarecovery/pushUpTheStandard";
